...
const base_url = "https://raw.githubusercontent.com/boglarkla/dark-neptun/main/";
const skins = ["DarkMode"];
...
function selectSkin(skinName) {
    css.href = base_url + skinName + "/main.css";
...
function
    ...
    var skin = window.localStorage.getItem('CustomSkin') || "DarkMode";
    selectSkin(skin);
}
